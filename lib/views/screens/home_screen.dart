                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage(data[index].imageUrl[0]),
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Icon(CupertinoIcons.money_dollar, size: 14, color: Colors.green,),
                                      Text("${data[index].price}", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),),
                                      Text("/night", style: TextStyle(fontSize: 14),)
                                    ],
                                  ),
                                ],
                              ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Icon(CupertinoIcons.money_dollar, color: Colors.green, size: 14,),
                                        Text(
                                          "${data[index].price}",
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold,
